...
ALTER TABLE ONLY public.purchase_details
    ADD CONSTRAINT purchase_details_pkey PRIMARY KEY (id_purchase_detail);


ALTER TABLE ONLY public.purchase_payments
    ADD CONSTRAINT purchase_payments_pkey PRIMARY KEY (id_purchase_payment);
...
ALTER TABLE ONLY public.sale_payments
    ADD CONSTRAINT sale_payments_pkey PRIMARY KEY (id_sale_payment);
...
ALTER TABLE ONLY public.customers
    ADD CONSTRAINT unique_customers_phone UNIQUE (phone);
...
ALTER TABLE ONLY public.suppliers
    ADD CONSTRAINT unique_suppliers_phone UNIQUE (phone);


ALTER TABLE ONLY public.users
    ADD CONSTRAINT unique_users_username UNIQUE (user_name);
